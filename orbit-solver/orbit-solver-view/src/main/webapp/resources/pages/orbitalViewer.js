...
OrbitalViewer.defaultSimulation = function () {
    OrbitalViewer.updateContextButtontext();
    //var defaultSim = {"success": true, "nBodies": 2, "objectList": [{"objectId": 0, "objectName": "SpaceObject-0", "objectMass": 1, "objectRadius": 1, "position": [0.7235651267737585, -0.32624551579833744], "velocity": [-0.3353032766657768, -0.7193894462648859], "render": {"lineWidth": 2, "strokeColour": "#ecabe1", "fillColour": "#ecabe1"}}, {"objectId": 1, "objectName": "SpaceObject-1", "objectMass": 1, "objectRadius": 1, "position": [-0.7235651196520418, 0.3262455190323509], "velocity": [0.3353032785345868, 0.7193894509487894], "render": {"lineWidth": 2, "strokeColour": "#84f891", "fillColour": "#84f891"}}], "simulationId": "2[1.000,1.000]", "totalMass": 2, "gravConstant": 1};
    var defaultSim = {"success": true, "nBodies": 2, 
        "objectList": [
            {"objectId": 0, "objectName": "SpaceObject-0", "objectMass": 15, "objectRadius": 1, 
                "position": [0.0, -0.0], "velocity": [-0.0, -0.0], "render": {"lineWidth": 2, "strokeColour": "#ecabe1", "fillColour": "#ecabe1"}}, 
            {"objectId": 1, "objectName": "SpaceObject-1", "objectMass": 1, "objectRadius": 1, 
                "position": [-10, 0], "velocity": [0, 1], "render": {"lineWidth": 2, "strokeColour": "#84f891", "fillColour": "#84f891"}}
        ], 
        "simulationId": "2[1.000,1.000]", "totalMass": 15.5, "gravConstant": 1};
